...
class ToDoTableViewController: UITableViewController, ToDoCellDelegate {
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    let toDo = toDos[indexPath.row]
      cell.titleLabel?.text = toDo.title
        cell.wasEatenButton.isSelected = toDo.wasEaten
      cell.delegate = self
    // Configure the cell...
    return cell
  }
  ...
  override func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
    ...
    @IBSegueAction func editToDo(_ coder: NSCoder, sender: Any?) -> UINavigationController? {
        let navigationController = UINavigationController(coder: coder)
            let detailController = navigationController?.viewControllers.first as? ToDoDetailTableViewController
