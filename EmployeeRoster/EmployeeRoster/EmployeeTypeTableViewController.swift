...
//  EmployeeRoster
//
//  Created by Megan Schmoyer on 11/3/23.
//

import UIKit

protocol EmployeeTypeTableViewControllerDelegate: AnyObject {
    func EmployeeTypeTableViewController(_ controller:
       EmployeeTypeTableViewController, didSelect employeeType:
       EmployeeType)
}
...
class EmployeeTypeTableViewController: UITableViewController, EmployeeTypeTableViewControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TypeOfEmployee", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.employeeType = selectedType
